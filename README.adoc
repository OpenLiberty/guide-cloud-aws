...
For more information or alternative ways to install the AWS CLI, see the
...
If you do not have an existing group, you need to create a new one.
...
creating, you will see an output similar to the following.
...
Take note of the repository URI for both the name and ping repository as you will need 
