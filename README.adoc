...
:page-description: Explore how to deploy microservices to Amazon Elastic Container Service for Kubernetes (EKS).
...
:page-seo-description: Learn how to push Docker images to Amazon ECR and run them inside of containers on Amazon EKS.
...
Explore how to push Docker images to an Amazon Elastic Container Registry and run them inside of containers on Amazon Elastic Container Service for Kubernetes.
...
deploying, managing, and scaling containerized applications. Single node {kube} clusters 
such as Minikube and Docker Desktop are great for testing your  microservices locally, 
but ultimately you will want a system that can handle production workloads and be able to 
deploy your microservices to the cloud as part of DevOps. Various clouds offer solutions 
for running your workloads in a {kube} cluster. Using a cloud-based infrastructure allows 
you to focus on developing your microservices rather than worrying about details that are 
related to the servers you deploy them to. Using cloud allows you to easily scale your 
microservices and serve them in a high-availability setup.
